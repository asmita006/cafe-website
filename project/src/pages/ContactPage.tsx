...
const ContactPage: React.FC = () => {
  useEffect(() => {
    document.title = 'Contact Us - Ice Cream Café';
  }, []);
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              We'd love to hear from you! Send us a message or visit our café.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Ice Cream Way<br />Sweet City, SC 12345</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@icecreamcafe.com</p>
                  </div>
                </div>
              ...
              <div className="mt-12">
                <h3 className="font-display font-bold text-xl text-gray-900 mb-4">Follow Us</h3>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-primary text-white font-medium rounded-lg flex items-center hover:bg-primary-dark transition-colors shadow-lg"
                >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="font-display font-bold text-3xl md:text-4xl text-gray-900 mt-2">
              Find Us Here
            </h2>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="rounded-xl overflow-hidden shadow-xl h-[400px] md:h-[500px]"
          >
            <iframe 
